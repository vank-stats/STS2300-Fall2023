...
**Answer:** We will use the size of the bill (explanatory variable) to help us predict / explain the tip size (response variable).
...
**Interpretation of y-intercept:** The predicted tip is -\$0.29 for a bill of \$0.00 at this bistro. This is clearly impossible and is partly because it doesn't make sense to have a \$0.00 bill.
