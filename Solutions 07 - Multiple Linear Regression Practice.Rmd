...
1. Make a graph to explore the distribution of the response variable. What do you notice?
...
**Answer:** The `ship_pr` variable has a p-value of 0.403, which is the highest of the slope terms. This suggests this variable may not actually be useful in our regression when we have all the others included.

<br>


4. After using backward selection to arrive at a final model, what is your equation? Fill in the equation below for this model.
...
$$\widehat{totalprice} = 38.62 - 0.4916 * duration + 0.1079 * start\_pr + 0.000026 * seller\_rate + 8.079 * wheels$$
...
9. Calculate the predicted price for a 7 day auction with a starting price of \$25, a seller rating of 3085, and 1 wheel included.
...
**Residual =** Response - predicted = -\$5.34
