...
4. (4 points) Calculate the p-value for this example and write a sentence explaining what it means in context of this example. (Note: This is not your interpretation yet.)
...
# Part 2 - Seeding Clouds (23 points total)
...
```{r, echo = FALSE}
rain <- read.csv("https://raw.githubusercontent.com/vank-stats/STS2720-Fall2022/main/rainfall.csv")
```
...
13. (3 points) Answer whichever of the following applies to your conclusion.
  - If you rejected the null... have we proven that the alternative hypothesis is correct? Why or why not?
  - If you failed to reject the null... does this suggest the null hypothesis is more likely to be correct than the alternative hypothesis is? Why or why not?
...
14. Answer **at least two** of the following questions:
...
b. This is the first time this course has been offered. What's something you think should be added, increased, or decreased in future semesters? Why would yo umake that change?
...
d. What advice would you give to a student taking the course this spring?
