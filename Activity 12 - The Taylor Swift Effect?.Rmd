...
4. Step 4 - Use your p-value to write a conclusion for your hypothesis test in context of this example.
...
5. Do you think it would make sense to use a theory-based hypothesis test to answer this question? Why or why not? (Hint: It would be the same test / conditions as we discussed with confidence intervals for a difference in means)
