...
**Answer:** There are 22 variables 112,184 observations
...
**Answer:** In the environment, I can see there are 13 observations (aka rows). When I summarize by playerID, I can see there are only five different players.
...
```{r, eval = TRUE}
results <- left_join(results, People, by = join_by(playerID))
```
