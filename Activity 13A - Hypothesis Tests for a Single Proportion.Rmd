...
6. Want extra practice? Suppose the COVID-19 sniffing dog (from Activity 10) will only be effective if it can identify at least 75% of positive COVID-19 cases. The data below includes only the IDs the dog made for positive samples of COVID-19. Carry out a hypothesis test based on this example.
